...
std::uint32_t const DECAlpha::op10[] = { 0x40,0x00,0x02,0x49,0x09,0x0B,0x0F,0x12,0x1B,0x1D,0x60,0x20,0x22,0x69,0x29,0x2B,0x2D,0x32,0x3B,0x3D,0x4D,0x6D };
std::uint32_t const DECAlpha::op11[] = { 0x00,0x08,0x14,0x16,0x20,0x24,0x26,0x28,0x40,0x44,0x46,0x48,0x61,0x64,0x66,0x6C };
std::uint32_t const DECAlpha::op12[] = { 0x02,0x06,0x0B,0x12,0x16,0x1B,0x22,0x26,0x2B,0x30,0x31,0x32,0x34,0x36,0x39,0x3B,0x3C,0x52,0x57,0x5A,0x62,0x67,0x6A,0x72,0x77,0x7A };
std::uint32_t const DECAlpha::op13[] = { 0x40,0x00,0x60,0x20,0x30 };
std::uint32_t const DECAlpha::op14[] = { 0x004,0x00A,0x08A,0x10A,0x18A,0x40A,0x48A,0x50A,0x58A,0x00B,0x04B,0x08B,0x0CB,0x10B,
...
std::uint32_t const DECAlpha::op15a[] = { 0x0A5,0x4A5,0x0A6,0x4A6,0x0A7,0x4A7,0x03C,0x0BC,0x03E,0x0BE };
std::uint32_t const DECAlpha::op15b[] = { 0x000,0x001,0x002,0x003,0x01E,0x020,0x021,0x022,0x023,0x02C,0x02D,0x02F };
std::uint32_t const DECAlpha::op16a[] = { 0x0A4,0x5A4,0x0A5,0x5A5,0x0A6,0x5A6,0x0A7,0x5A7,0x2AC,0x6AC };
std::uint32_t const DECAlpha::op16b[] = { 0x00,0x01,0x02,0x03,0x20,0x21,0x22,0x23,0x2C,0x2F };
std::uint32_t const DECAlpha::op17[] = { 0x010,0x020,0x021,0x022,0x024,0x025,0x02A,0x02B,0x02C,0x02D,0x02E,0x02F,0x030,0x130,0x530 };
std::uint32_t const DECAlpha::op18[] = { 0x0000,0x0400,0x4000,0x4400,0x8000,0xA000,0xC000,0xE000,0xE800,0xF000,0xF800,0xFC00 };
std::uint32_t const DECAlpha::op1C[] = { 0x00,0x01,0x30,0x31,0x32,0x33,0x34,0x35,0x36,0x37,0x38,0x39,0x3A,0x3B,0x3C,0x3D,0x3E,0x3F,0x70,0x78 };
...
bool DECAlpha::IsValidInstruction(std::uint32_t const instruction) {
  std::uint32_t opcode = instruction >> 26, function = 0;
  switch (opcode) {
    case 0: { // PAL
...
void DECAlpha::Shuffle(std::uint32_t& instruction) {
  std::uint32_t const opcode = instruction >> 26;
